...
if (isset($_POST['submit'])) {
    ...
    $last_record_estate = mysqli_insert_id($connection);

    session_start();
    $logged_in_user = $_SESSION['user_id'];

    $sql_Estate_In_Landlord = "insert into estates_in_landlords
         (EstateID, LandlordID)
         values
         ( " . $last_record_estate . ",
           " . $logged_in_user . ") ";

    $result_estate_in_landlords = mysqli_query($connection, $sql_Estate_In_Landlord);
